...
export const endpointAccessMap = {
  ...
  usersAssignCompany: endpoint({ method: "PATCH", path: "/users/:id/companies/assign", permission: Permissions.UsersUpdate, scope: EndpointScopes.Global }),
  usersUnassignCompany: endpoint({ method: "PATCH", path: "/users/:id/companies/unassign", permission: Permissions.UsersUpdate, scope: EndpointScopes.Global }),
  ...
  companiesByTin: endpoint({ method: "GET", path: "/companies/by-tin/:tin", permission: Permissions.CompaniesLegalInfoRead, scope: EndpointScopes.Company }),
